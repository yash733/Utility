...
class back_create_resume(BaseModel):
    ...
    suggestion : str = Field(description=f'If {sentiment} == "Improvement Required", then provide detailed instruction and areas of improvement required to improve resume impact increasing selection chances.')